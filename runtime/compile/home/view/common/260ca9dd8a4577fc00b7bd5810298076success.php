<html>
	...
	<body>
		<div id="notice">
			...
			<div style="width:100%;text-align:left;padding-left:10px;padding-right:10px"><<?php echo $this->_vars['mess']; ?>></div>
				
			<?php if($this->_vars['mark']){ ?>
			...
			<?php } ?>		
			<p>
				 在( <span id="sec" style="color:blue;font-weight:bold"><<?php echo $this->_vars['timeout']; ?>></span> )秒后自动跳转，或直接点击 <a href="javascript:<?php echo $this->_vars['location']; ?>">这里</a> 跳转<br>
		 ...
		 <script>
				...
				var time=<?php echo $this->_vars['timeout']; ?>;
				var tt=setInterval(function(){
						time--;
						seco.innerHTML=time;	
						if(time<=0){
							<?php echo $this->_vars['location']; ?>;
							return;
						}
					}, 1000);
				function stop(obj){
