...
<h2>注册!</h2>
<b>想试试Retwis? 请注册账号!</b>
<form method="POST" action="/home/retwis/register">
<table>
<tr>
...
<h2>已经注册了? 请直接登陆</h2>
<form method="POST" action="/home/retwis/login">
<table><tr>
  <td>用户名</td><td><input type="text" name="username"></td>
  </tr><tr>
  <td>密码:</td><td><input type="password" name="password"></td>
...
<li>PHP与redis服务器的连接用pecl的官方扩展<a href="http://pecl.php.net/package/redis">php-redis</a>
</ul>
</div>
